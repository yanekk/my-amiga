...
;		#-----+-----------------------------------------#
;		|Name:| P6110 - Optimized Player 6.1 Playroutine|
;		+-----+-----------------------------------------+
;		|V1.04|	P6110 final, E6x command fix+new option	|
;		|V1.03|	P6109 final, compatibility changes only.|
...
;-----------------------------
;This is 'project finished' for me for the foreseeable future. This is my 
;finished P61 player. There is nothing left to optimize, and I've gone through
;everything I could find that could possibly be bad with it and fixed it.

;A bug regarding Patternloops (E6x) was introduced in P6108 when I added the 
...
samples:		;ds.b 65536 <--declare som space if used.
